...
- `premium-calibration.md`
  - Use after the urban brief to raise the level of control and restraint without leaving the city concept.
...
- `data/cities.md`
  - Use to present region-appropriate cities and urban references.
...
- `data/narrative-beats.md`
  - Use to map page flow to an urban arc.
...
```bash
rg -n "Tokyo|Paris|London|New York" references/data/cities.md
