# Hero Archetypes Library — 30 Urban Hero Structures
...
Every hero section must start from an archetype. Archetypes define the **skeleton** (locked) while leaving **skin** (flex) to the urban + culture system.

**Usage:** Step 3.9 — after Urban Brief, before Storyboard. Select archetype via Urban Preference Pool mechanism.
...
- **Flex** = options that go through urban pool validation ("would this director use this?")
- **Forbidden** = combinations that break this archetype's logic
- **Urban Flow Fit** = Tier 1 (perfect) / Tier 2 (works with adaptation) / Tier 3 (avoid)
