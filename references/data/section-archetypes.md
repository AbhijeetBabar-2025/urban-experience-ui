...
- **Entrance** → MANDATORY reference from `urban-flow-50.md`
- **Interaction** → MANDATORY reference from `interaction-effects-50.md`
- **Urban Flow Fit** → Tier 1/2/3

**CRITICAL:** Every archetype MUST reference specific entries from urban-flow and interaction-effects libraries. If an archetype has no interaction reference, it means "no hover/click/scroll effect" — which must be an intentional urban choice (e.g., "Villeneuve's restraint"), NOT laziness.

**Usage:** Step 3.95 — after selecting narrative beats and resolving to functions, select the archetype for each function via urban pool + hash mechanism.
...
- Entrance: urban-flow #{N} — [name]
- Interaction: interaction-effects #{N} — [name]
- Urban Flow Fit: Tier 1: [...] / Tier 2: [...] / Tier 3: [...]
...
- Entrance: urban-flow #20 Jump cut stagger (cards appear 0.05s apart)
- Interaction: interaction-effects #4 Depth-of-field pop (unfocused cards blur, hovered card sharpens)
- Urban Flow Fit: Tier 1: Fincher, Wes Anderson / Tier 2: Nolan, Kubrick / Tier 3: Malick
...
- Entrance: urban-flow #30 Tracking shot lateral (scroll reveals cards)
- Interaction: interaction-effects #5 Film frame lift (hover card lifts with border)
- Urban Flow Fit: Tier 1: Edgar Wright, Wes Anderson / Tier 2: Tarantino, Guy Ritchie / Tier 3: Villeneuve
...
- Entrance: urban-flow #2 Fade from black (each card fades in on scroll)
- Interaction: interaction-effects #3 Color temperature shift (hover warms the card)
- Urban Flow Fit: Tier 1: Villeneuve, Malick, Wong Kar-wai / Tier 2: Sofia Coppola / Tier 3: Edgar Wright
...
- Entrance: urban-flow #20 Jump cut stagger (rapid appearance, 0.03s gaps)
- Interaction: interaction-effects #1 Spotlight reveal (cursor spotlight follows mouse across grid)
- Urban Flow Fit: Tier 1: Fincher (Zodiac evidence), Nolan / Tier 2: Park Chan-wook / Tier 3: Wes Anderson
...
- Entrance: urban-flow #10 Curtain wipe (cards slide in from right)
- Interaction: interaction-effects #22 Expand to fullscreen (click card expands)
- Urban Flow Fit: Tier 1: Spielberg, Miyazaki / Tier 2: Ridley Scott / Tier 3: Fincher
...
- Entrance: urban-flow #4 Crane down (content descends into view)
- Interaction: interaction-effects #12 Underline slide (hover reveals underline)
- Urban Flow Fit: Tier 1: Nolan (time), Tarantino (chapters) / Tier 2: Wes Anderson / Tier 3: Miyazaki
...
- Entrance: urban-flow #7 Split diopter open (cells reveal from center out)
- Interaction: interaction-effects #2 Perspective tilt (hover tilts card in 3D)
- Urban Flow Fit: Tier 1: Wes Anderson, Park Chan-wook / Tier 2: Nolan, Kubrick / Tier 3: Malick
...
- Entrance: urban-flow #33 Parallax depth layers (cards at different scroll speeds)
- Interaction: interaction-effects #28 Sticky spotlight (top card stays visible, new cards push over)
- Urban Flow Fit: Tier 1: Nolan, Villeneuve / Tier 2: Kubrick / Tier 3: Edgar Wright
...
- Entrance: urban-flow #6 Rack focus reveal (blur to sharp on image)
- Interaction: interaction-effects #30 Parallax text float (text floats upward on scroll)
- Urban Flow Fit: Tier 1: Villeneuve, Nolan / Tier 2: Malick, Ridley Scott / Tier 3: Edgar Wright
...
- Entrance: urban-flow #16 Lens flare bloom (brightness → normal)
- Interaction: interaction-effects #13 Ken Burns drift (hover slowly pans across image)
- Urban Flow Fit: Tier 1: Ridley Scott, Zhang Yimou / Tier 2: Spielberg, Nolan / Tier 3: Wes Anderson
...
- Entrance: urban-flow #7 Split diopter open (left and right halves slide in)
- Interaction: interaction-effects #16 Curtain lift reveal (hover lifts overlay on image side)
- Urban Flow Fit: Tier 1: De Palma, Park Chan-wook / Tier 2: Fincher, Nolan / Tier 3: Miyazaki
...
- Entrance: urban-flow #3 Dolly-in push forward (card grows from small to featured size)
- Interaction: interaction-effects #22 Expand to fullscreen (click expands)
- Urban Flow Fit: Tier 1: Kubrick, Wes Anderson / Tier 2: Fincher / Tier 3: Ridley Scott
...
- Entrance: urban-flow #29 Dolly zoom Vertigo effect (bg scale + fg counter-scale)
- Interaction: interaction-effects #32 Horizontal reveal on vertical scroll
- Urban Flow Fit: Tier 1: Nolan (Inception), Hitchcock / Tier 2: Park Chan-wook / Tier 3: Wes Anderson
...
- Entrance: urban-flow #2 Fade from black (slow, 2s fade)
- Interaction: interaction-effects #20 Weight morph (hover shifts font weight via variable font)
- Urban Flow Fit: Tier 1: Wong Kar-wai, Malick, Sofia Coppola / Tier 2: Tarkovsky / Tier 3: Guy Ritchie
...
- Entrance: urban-flow #20 Jump cut stagger (panels appear rapidly)
- Interaction: interaction-effects #4 Depth-of-field pop (hovered panel sharpens, others blur)
- Urban Flow Fit: Tier 1: Zhang Yimou (color worlds), Wes Anderson / Tier 2: Miyazaki / Tier 3: Fincher
...
- Entrance: urban-flow #13 Bird's eye descent (zoom from above into the map)
- Interaction: interaction-effects #38 Magnetic cursor (categories pulled toward cursor)
- Urban Flow Fit: Tier 1: Nolan (Inception), Kubrick / Tier 2: Fincher / Tier 3: Miyazaki
- Description: Center topic with subtopics orbiting around it. Solar system layout.

### CM-3: Horizontal Scroll Categories
- Layout: compositions #24 Horizontal overflow reveal
- Entrance: urban-flow #36 Crab shot lateral track (horizontal slide reveal)
- Interaction: interaction-effects #5 Film frame lift (hover lifts category card)
- Urban Flow Fit: Tier 1: Wes Anderson (tracking), Edgar Wright / Tier 2: Park Chan-wook / Tier 3: Villeneuve
...
- Entrance: urban-flow #2 Fade from black
- Interaction: interaction-effects #24 Accordion unfold (click expands category to show subcontent)
- Urban Flow Fit: Tier 1: Fincher (clinical), Villeneuve / Tier 2: Nolan / Tier 3: Wes Anderson
...
- Entrance: urban-flow #8 Tilt up reveal (each band tilts into view)
- Interaction: interaction-effects #3 Color temperature shift (hover warms the band)
- Urban Flow Fit: Tier 1: Kubrick, Ridley Scott / Tier 2: Leone / Tier 3: Edgar Wright
...
- Entrance: urban-flow #17 Film projector flicker (tags flicker into existence)
- Interaction: interaction-effects #8 Magnetic snap (tags magnetically attract to cursor)
- Urban Flow Fit: Tier 1: Edgar Wright, Guy Ritchie / Tier 2: Tarantino / Tier 3: Villeneuve
...
- Entrance: urban-flow #2 Fade from black + JS counter animation
- Interaction: interaction-effects #29 Progress bar (scroll drives counter)
- Urban Flow Fit: Tier 1: Nolan, Fincher / Tier 2: Spielberg / Tier 3: Miyazaki
...
- Entrance: urban-flow #3 Dolly-in push forward (number grows into frame)
- Interaction: interaction-effects #33 Zoom to detail (scroll zooms into the number)
- Urban Flow Fit: Tier 1: Kubrick, Nolan / Tier 2: Villeneuve / Tier 3: Wes Anderson
...
- Entrance: urban-flow #20 Jump cut stagger (widgets appear rapidly)
- Interaction: interaction-effects #7 Hologram flicker (hover makes widget glow)
- Urban Flow Fit: Tier 1: Fincher, Ridley Scott (Blade Runner) / Tier 2: Nolan / Tier 3: Miyazaki
...
- Entrance: urban-flow #34 Time-lapse acceleration (speed up on scroll)
- Interaction: interaction-effects #30 Parallax text float (numbers float at different speeds)
- Urban Flow Fit: Tier 1: Nolan (time), Villeneuve / Tier 2: Kubrick / Tier 3: Edgar Wright
...
- Entrance: urban-flow #19 Match cut dissolve (before morphs into after)
- Interaction: interaction-effects #27 Toggle light/dark (click toggles before/after)
- Urban Flow Fit: Tier 1: Nolan, Park Chan-wook / Tier 2: Fincher / Tier 3: Miyazaki
...
- Entrance: urban-flow #2 Fade from black (number fades in as giant ghost text behind)
- Interaction: No interaction (intentional stillness)
- Urban Flow Fit: Tier 1: Villeneuve (silence), Malick / Tier 2: Wong Kar-wai / Tier 3: Guy Ritchie
...
- Entrance: urban-flow #2 Fade from black (slow, deliberate)
- Interaction: interaction-effects #9 Neon charge-up (submit button charges on hover)
- Urban Flow Fit: Tier 1: Nolan, Fincher / Tier 2: Hitchcock / Tier 3: Miyazaki
...
- Entrance: urban-flow #12 Steadicam float-in (card gently floats into view)
- Interaction: interaction-effects #11 Elastic bounce (button bounces on hover)
- Urban Flow Fit: Tier 1: Miyazaki, Sofia Coppola, Wong Kar-wai / Tier 2: Wes Anderson / Tier 3: Fincher
...
- Entrance: urban-flow #10 Curtain wipe (color block wipes in)
- Interaction: interaction-effects #10 Shutter click (button flashes white on hover)
- Urban Flow Fit: Tier 1: Guy Ritchie, Tarantino, Edgar Wright / Tier 2: Spike Lee / Tier 3: Villeneuve
...
- Entrance: urban-flow #7 Split diopter open (left/right slide in simultaneously)
- Interaction: interaction-effects #12 Underline slide (hover underlines input)
- Urban Flow Fit: Tier 1: Wes Anderson, Kubrick / Tier 2: Nolan / Tier 3: Malick
...
- Entrance: urban-flow #6 Rack focus reveal (blurred → sharp as you reach it)
- Interaction: interaction-effects #28 Sticky spotlight (CTA stays while background scrolls)
- Urban Flow Fit: Tier 1: Nolan, Villeneuve / Tier 2: Fincher / Tier 3: Wes Anderson
...
- Urban Flow Fit: Tier 1: Villeneuve, Malick, Jarmusch / Tier 2: Sofia Coppola / Tier 3: Edgar Wright
...
- Entrance: urban-flow #21 Crossfade overlap (quotes dissolve between each other)
- Interaction: interaction-effects #13 Ken Burns drift (background slowly drifts)
- Urban Flow Fit: Tier 1: Wong Kar-wai, Sofia Coppola / Tier 2: Wes Anderson / Tier 3: Fincher

### TM-2: Stacked Monologue
- Layout: compositions #27 Narrow column
- Entrance: urban-flow #2 Fade from black (quotes fade in one by one)
- Interaction: interaction-effects #20 Weight morph (text weight shifts on hover)
- Urban Flow Fit: Tier 1: Malick, Villeneuve / Tier 2: Nolan / Tier 3: Guy Ritchie

### TM-3: Grid of Faces
- Layout: compositions #5 Triptych or #40 Corner split
- Entrance: urban-flow #20 Jump cut stagger
- Interaction: interaction-effects #2 Perspective tilt (card tilts toward cursor)
- Urban Flow Fit: Tier 1: Wes Anderson, Fincher / Tier 2: Spielberg / Tier 3: Villeneuve

### TM-4: Full-Width Single Quote
- Layout: compositions #23 Viewport fill
- Entrance: urban-flow #2 Fade from black (slow, 2.5s)
- Interaction: No interaction (let the words breathe)
- Urban Flow Fit: Tier 1: Kubrick, Villeneuve, Tarkovsky / Tier 2: Nolan / Tier 3: Edgar Wright

### TM-5: Evidence Tape Wall
- Layout: compositions #41 Overlapping cards cascade
- Entrance: urban-flow #32 Handheld shake (slight movement, documentary feel)
- Interaction: interaction-effects #1 Spotlight reveal (cursor highlights testimonials)
- Urban Flow Fit: Tier 1: Fincher (Zodiac), Park Chan-wook / Tier 2: Spike Lee / Tier 3: Sofia Coppola
...
- Entrance: urban-flow #2 Fade from black (3s, the slowest entrance)
- Interaction: No interaction
- Urban Flow Fit: Tier 1: Kubrick, Villeneuve, Malick / Tier 2: Nolan / Tier 3: Edgar Wright

### QP-2: Inset with Giant Quotation Mark
- Layout: compositions #31 Inset margin columns
- Entrance: urban-flow #8 Tilt up reveal
- Interaction: interaction-effects #20 Weight morph (variable font shifts)
- Urban Flow Fit: Tier 1: Wes Anderson, Wong Kar-wai / Tier 2: Sofia Coppola / Tier 3: Fincher

### QP-3: Side-Aligned Editorial
- Layout: compositions #10 Rule-of-thirds content right
- Entrance: urban-flow #5 Whip pan entrance (slides in from left, fast)
- Interaction: interaction-effects #12 Underline slide
- Urban Flow Fit: Tier 1: Tarantino, Guy Ritchie, Spike Lee / Tier 2: Edgar Wright / Tier 3: Villeneuve

### QP-4: Background Ghost Text
- Layout: compositions #42 Background text with foreground content
- Entrance: urban-flow #48 Defocus exit (reverse — starts blurry, becomes sharp)
- Interaction: interaction-effects #15 Parallax depth hover (text layers shift with cursor)
- Urban Flow Fit: Tier 1: Wong Kar-wai, Fincher / Tier 2: Nolan / Tier 3: Miyazaki
...
- Urban Flow Fit: All directors (universal)

### FT-2: Minimal Single Row
- Layout: compositions #27 Narrow column
- Entrance: No entrance animation
- Interaction: No interaction
- Urban Flow Fit: Tier 1: Villeneuve, Kubrick, Jarmusch / Tier 2: Malick / Tier 3: Wes Anderson
...
- Urban Flow Fit: Tier 1: Wes Anderson, Sofia Coppola / Tier 2: Miyazaki / Tier 3: Fincher
...
- Entrance: No entrance animation
- Interaction: interaction-effects #12 Underline slide
- Urban Flow Fit: Tier 1: Fincher, Nolan / Tier 2: Wes Anderson / Tier 3: Malick
...
- Urban Flow Fit: All directors

### VB-2: Parallax Image Band
- Layout: compositions #25 Parallax layer stack
- Entrance: urban-flow #33 Parallax depth layers
- Interaction: interaction-effects #13 Ken Burns drift
- Urban Flow Fit: Tier 1: Malick, Ridley Scott / Tier 2: Villeneuve / Tier 3: Wes Anderson

### VB-3: Divider with Accent Line
- Layout: Single `<hr>` or decorative line
- Entrance: urban-flow #10 Curtain wipe (line draws across)
- Interaction: No interaction
- Urban Flow Fit: Tier 1: Kubrick, Wes Anderson (precise) / Tier 2: Fincher / Tier 3: Miyazaki

### VB-4: Empty Space
- Layout: Just `padding: 200px 0` — literally nothing
- Entrance: None
- Interaction: None
- Urban Flow Fit: Tier 1: Villeneuve, Malick, Tarkovsky / Tier 2: Kubrick / Tier 3: All action directors
...
- Entrance: urban-flow #4 Crane down (entries descend into view)
- Interaction: interaction-effects #12 Underline slide (hover reveals date detail)
- Urban Flow Fit: Tier 1: Nolan (time obsession), Fincher / Tier 2: Wes Anderson, Tarantino (chapters) / Tier 3: Malick

### TL-2: Horizontal Scroll Timeline
- Layout: compositions #24 Horizontal overflow reveal
- Entrance: urban-flow #30 Tracking shot lateral
- Interaction: interaction-effects #5 Film frame lift (hover lifts era card)
- Urban Flow Fit: Tier 1: Edgar Wright, Wes Anderson / Tier 2: Guy Ritchie / Tier 3: Villeneuve

### TL-3: Stacked Full-Width Eras
- Layout: compositions #37 Vertical split (full-width horizontal bands per era)
- Entrance: urban-flow #2 Fade from black (each era fades in sequentially)
- Interaction: interaction-effects #3 Color temperature shift (hover warms era)
- Urban Flow Fit: Tier 1: Kubrick, Ridley Scott / Tier 2: Nolan / Tier 3: Edgar Wright

### TL-4: Filmstrip Timeline
- Layout: compositions #42 Film strip advance (scroll-snap frames)
- Entrance: urban-flow #42 Film strip advance (frames snap into place)
- Interaction: interaction-effects #22 Expand to fullscreen (click era expands)
- Urban Flow Fit: Tier 1: Tarantino (chapter structure), Park Chan-wook / Tier 2: Wes Anderson / Tier 3: Malick

### TL-5: Single-Column Diary
- Layout: compositions #27 Narrow column reading width
- Entrance: urban-flow #2 Fade from black (gentle, 1.5s per entry)
- Interaction: No interaction (reading experience, not interactive)
- Urban Flow Fit: Tier 1: Wong Kar-wai (memory), Sofia Coppola, Iwai / Tier 2: Malick / Tier 3: Guy Ritchie
...
- Entrance: urban-flow #20 Jump cut stagger (steps appear rapidly)
- Interaction: interaction-effects #24 Accordion unfold (click expands step detail)
- Urban Flow Fit: Tier 1: Fincher (methodical), Nolan / Tier 2: Kubrick / Tier 3: Wong Kar-wai

### PS-2: Horizontal Step Cards
- Layout: compositions #24 Horizontal overflow with scroll-snap
- Entrance: urban-flow #10 Curtain wipe (steps slide in left to right)
- Interaction: interaction-effects #5 Film frame lift (hover lifts step card)
- Urban Flow Fit: Tier 1: Wes Anderson (precise choreography), Edgar Wright / Tier 2: Guy Ritchie / Tier 3: Malick

### PS-3: Sticky Step Counter
- Layout: compositions #43 Sticky image with scrolling text (step number sticks, detail scrolls)
- Entrance: urban-flow #33 Parallax depth layers (numbers at different speeds)
...
- Entrance: urban-flow #13 Bird's eye descent (overview then zoom)
- Interaction: interaction-effects #2 Perspective tilt (hover tilts step card)
- Urban Flow Fit: Tier 1: Kubrick (systematic), Wes Anderson / Tier 2: Fincher / Tier 3: Miyazaki

### PS-5: Cinematic Sequence
- Layout: compositions #62 Sticky hero dissolve (each step transforms the same space)
- Entrance: urban-flow #19 Match cut dissolve (step A dissolves into step B)
- Interaction: interaction-effects #32 Horizontal reveal on vertical scroll
- Urban Flow Fit: Tier 1: Nolan (Inception layers), Park Chan-wook / Tier 2: Villeneuve / Tier 3: Edgar Wright
...
- Urban Flow Fit: Tier 1: Fincher, Villeneuve (clinical) / Tier 2: Kubrick, Nolan / Tier 3: Wes Anderson
...
- Urban Flow Fit: Tier 1: Wes Anderson (symmetry), Kubrick / Tier 2: Fincher / Tier 3: Malick
...
- Urban Flow Fit: Tier 1: Edgar Wright, Guy Ritchie (playful) / Tier 2: Wes Anderson / Tier 3: Villeneuve

### FQ-4: Progressive Reveal on Scroll
- Layout: compositions #27 Narrow column
- Entrance: urban-flow #33 Parallax depth layers (questions at different scroll speeds)
- Interaction: No interaction (answers are always visible, questions scroll past)
- Urban Flow Fit: Tier 1: Malick, Wong Kar-wai / Tier 2: Sofia Coppola, Iwai / Tier 3: Fincher
...
- Entrance: urban-flow #2 Fade from black (content crossfades on tab switch)
- Interaction: interaction-effects #21 Crossfade overlap (tab panels dissolve between each other)
- Urban Flow Fit: Tier 1: Wes Anderson (organized), Kubrick / Tier 2: Fincher, Nolan / Tier 3: Wong Kar-wai

### TC-2: Vertical Side Tabs
- Layout: compositions #29 Sidebar + main constrained (tabs left, content right)
- Entrance: urban-flow #5 Whip pan entrance (content slides in from right on tab change)
- Interaction: interaction-effects #10 Shutter click (tab change flashes)
- Urban Flow Fit: Tier 1: Fincher, Nolan / Tier 2: Kubrick / Tier 3: Miyazaki

### TC-3: Full-Width Color Shift
- Layout: compositions #23 Viewport fill (entire section changes color per tab)
- Entrance: urban-flow #21 Crossfade overlap (background color fades between tabs)
- Interaction: interaction-effects #31 Color shift on scroll position (adapted to tab position)
- Urban Flow Fit: Tier 1: Zhang Yimou (color worlds), Miyazaki, Iwai / Tier 2: Wes Anderson / Tier 3: Fincher

### TC-4: Stack Reveal
- Layout: compositions #63 Progressive sticky stack (each tab panel stacks over the previous)
- Entrance: urban-flow #3 Dolly-in push forward (new panel pushes toward viewer)
- Interaction: interaction-effects #28 Sticky spotlight
- Urban Flow Fit: Tier 1: Nolan (layering), Park Chan-wook / Tier 2: Villeneuve / Tier 3: Edgar Wright
...
- Layout: compositions #43 Sticky image with scrolling text
- Entrance: urban-flow #6 Rack focus reveal (visual sharpens as you scroll into section)
...
- Entrance: urban-flow #36 Crab shot lateral track
- Interaction: interaction-effects #32 Horizontal reveal on vertical scroll
- Urban Flow Fit: Tier 1: Nolan (Inception), Wes Anderson (lateral tracking) / Tier 2: Park Chan-wook / Tier 3: Malick

### SS-3: Progressive Reveal (Background Transforms)
- Layout: compositions #23 Viewport fill with scroll-driven transforms
- Entrance: urban-flow #29 Dolly zoom Vertigo effect (bg scales while fg stays)
- Interaction: interaction-effects #33 Zoom to detail (scroll zooms into content)
- Urban Flow Fit: Tier 1: Hitchcock, Fincher / Tier 2: Nolan, Park Chan-wook / Tier 3: Miyazaki

### SS-4: Frame Sequence (Scroll Scrubber)
- Layout: compositions #23 Viewport fill + JS frame sequence
- Entrance: urban-flow #34 Time-lapse acceleration (frames speed up on scroll)
- Interaction: interaction-effects #43 Freeze frame hold (key moments pause)
- Urban Flow Fit: Tier 1: Kubrick, Nolan / Tier 2: Fincher / Tier 3: Wong Kar-wai
...
- Entrance: urban-flow #20 Jump cut stagger (images appear rapidly)
- Interaction: interaction-effects #13 Ken Burns drift (hover slowly pans image)
- Urban Flow Fit: Tier 1: Wong Kar-wai, Ridley Scott / Tier 2: Malick / Tier 3: Kubrick

### GL-2: Horizontal Scroll Gallery
- Layout: compositions #24 Horizontal overflow reveal
- Entrance: urban-flow #30 Tracking shot lateral
- Interaction: interaction-effects #22 Expand to fullscreen (click image expands)
- Urban Flow Fit: Tier 1: Wes Anderson, Edgar Wright / Tier 2: Park Chan-wook / Tier 3: Villeneuve

### GL-3: Lightbox Grid
- Layout: compositions #5 Triptych or #40 Corner split
- Entrance: urban-flow #2 Fade from black
- Interaction: interaction-effects #16 Curtain lift reveal (hover lifts overlay to reveal detail)
- Urban Flow Fit: Tier 1: Kubrick, Fincher / Tier 2: Nolan / Tier 3: Guy Ritchie

### GL-4: Full-Screen Slideshow
- Layout: compositions #23 Viewport fill (one image at a time, full screen)
- Entrance: urban-flow #21 Crossfade overlap (images dissolve between each other)
- Interaction: No interaction (images auto-advance or scroll-driven)
- Urban Flow Fit: Tier 1: Malick, Villeneuve, Tarkovsky / Tier 2: Wong Kar-wai, Iwai / Tier 3: Edgar Wright
...
- Entrance: urban-flow #20 Jump cut stagger (widgets appear 0.04s apart)
- Interaction: interaction-effects #7 Hologram flicker (hover makes widget glow)
- Urban Flow Fit: Tier 1: Fincher, Nolan / Tier 2: Ridley Scott / Tier 3: Miyazaki

### DD-2: Single Metric Focus
- Layout: compositions #23 Viewport fill (one big number + supporting sparkline)
- Entrance: urban-flow #3 Dolly-in push forward
- Interaction: interaction-effects #33 Zoom to detail (scroll zooms into metric)
- Urban Flow Fit: Tier 1: Kubrick, Nolan / Tier 2: Fincher / Tier 3: Wes Anderson

### DD-3: Ticker Strip
- Layout: compositions #21 Edge-to-edge immersion (full-width scrolling data)
- Entrance: urban-flow #30 Tracking shot lateral (continuous horizontal scroll)
- Interaction: No interaction (always moving, like a stock ticker)
- Urban Flow Fit: Tier 1: Fincher (Social Network), Guy Ritchie / Tier 2: Nolan / Tier 3: Malick

### DD-4: Stacked Data Cards
- Layout: compositions #3 Centered stack (cards stacked vertically)
- Entrance: urban-flow #2 Fade from black (each card fades in)
- Interaction: interaction-effects #2 Perspective tilt (hover tilts card)
- Urban Flow Fit: Tier 1: Wes Anderson, Kubrick / Tier 2: Fincher / Tier 3: Ridley Scott
...
- Entrance: urban-flow #7 Split diopter open (left and right slide in)
- Interaction: interaction-effects #3 Color temperature shift (hover warms image)
- Urban Flow Fit: Tier 1: Villeneuve, Ridley Scott / Tier 2: Fincher / Tier 3: Edgar Wright
...
- Urban Flow Fit: Tier 1: Wes Anderson, Sofia Coppola / Tier 2: Wong Kar-wai, Iwai / Tier 3: Fincher
...
- Urban Flow Fit: Tier 1: Wes Anderson (ensemble), Park Chan-wook / Tier 2: Tarantino / Tier 3: Villeneuve
...
- Urban Flow Fit: Tier 1: Malick, Wong Kar-wai, Iwai / Tier 2: Sofia Coppola / Tier 3: Guy Ritchie
...
- Entrance: urban-flow #7 Split diopter open
- Interaction: JS drag slider to reveal before/after
- Urban Flow Fit: Tier 1: Nolan (time), Fincher / Tier 2: Park Chan-wook / Tier 3: Miyazaki

### BA-2: Toggle Switch
- Layout: compositions #23 Viewport fill (full-screen, click toggles between states)
- Entrance: urban-flow #19 Match cut dissolve (states morph between each other)
...
- Entrance: urban-flow #29 Dolly zoom (scale distortion during morph)
- Interaction: interaction-effects #44 Depth of field shift on scroll
- Urban Flow Fit: Tier 1: Nolan (Interstellar), Villeneuve / Tier 2: Fincher / Tier 3: Edgar Wright
...
- Urban Flow Fit: Tier 1: Edgar Wright, Guy Ritchie / Tier 2: Fincher / Tier 3: Villeneuve

### MQ-2: Slow Drift Text
- Layout: Full-width, oversized text slowly drifting (8-15s per cycle)
- Entrance: urban-flow #2 Fade from black
- Interaction: No interaction
- Urban Flow Fit: Tier 1: Wong Kar-wai, Malick, Iwai / Tier 2: Sofia Coppola / Tier 3: Nolan
...
- Urban Flow Fit: Tier 1: Fincher (corporate), Nolan / Tier 2: Wes Anderson / Tier 3: Malick
...
5. Record the selection in storyboard.md with:
   ...
   - Entrance reference (urban-flow.md #)
...
- Entrance: urban-flow.md #{N} — [name]
- Interaction: interaction-effects.md #{N} — [name]
- Urban Flow Justification: [Why this director would use this specific combination]
