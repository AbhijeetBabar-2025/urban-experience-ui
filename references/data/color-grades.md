# Color Grading Library — 100 Urban & Sonic Presets

CSS filter combinations that replicate urban and cultural lighting. Apply to images, sections, or full-page overlays via `filter:` or as pseudo-element overlays with `mix-blend-mode`.
...
| # | Name | Sonic / Urban Reference | CSS Filter | Mood |
|---|------|---------------|------------|------|
