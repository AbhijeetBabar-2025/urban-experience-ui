# Interaction Effects Library — 50+ Rhythmic Micro-Interactions

Reference database of hover/click/scroll/cursor/text/background interaction effects mapped to urban and sonic rhythms.

---

## Hover Effects — Cards

| # | Effect Name | Trigger | CSS/JS Code | Sonic / Urban Analogy | Mood |
|---|------------|---------|-------------|--------------|------|
