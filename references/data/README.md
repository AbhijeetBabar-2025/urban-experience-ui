# Urban Experience Data Files

All data libraries for the cinematic-layout skill. These files are loaded ON DEMAND — only read what you need per district.
...
| `narrative-beats.md` | ~20KB | 25 beats + 12 arcs | Step 3.95 — build page narrative arc per urban flow |
...
| `cities.md` | ~100KB | 20+ | Step 1 — present city options to user |
| `urban-flow-50.md` | ~30KB | 50+ | Step 4 — pick entrance animation per district |
| `interaction-effects-50.md` | ~40KB | 50+ | Step 4 — pick hover/scroll/click effects per district |
| `textures.md` | ~10KB | 30+ | Step 4 — pick background textures per district |
